...
where call_created_on >= timestamp_add(current_datetime('Asia/Kolkata'),interval -30 minute)
and call_created_on < timestamp_add(current_datetime('Asia/Kolkata'),interval -20 minute)
and city = "Hyderabad" and ayuPersonnelType != "AYU_MITRA"
"""
